...
class Car {
  ...
  drive(distance){
    ...
    this.tank -= (distance/this.milesPerGallon)
      ...
      const num1 = this.tank;
      this.tank = 0;
      return 'I ran out of fuel at '+(num1*this.milesPerGallon)+' miles!';
    }
  }
}
...
class Student extends Lambdasian {
  constructor(z){
    super(z);
    this.previousBackground = z.previousBackground;
    this.className = z.className;
    this.favSubjects = z.favSubjects;
  }
  listSubjects(){
...
class ProjectManager extends Instructor {
  constructor (y){
    super(y);
    this.gradClassName=y.gradClassName;
    this.favInstructor=y.favInstructor;
  }
   standUp(channel){
